...
func (*Point) Descriptor() ([]byte, []int) {
	return fileDescriptor_453e3c55db197998, []int{0}
}
...
func (*PointRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_453e3c55db197998, []int{1}
}
...
func (m *PointRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PointRequest.Merge(m, src)
}
...
func (*BoundedPointsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_453e3c55db197998, []int{2}
}
...
func (m *BoundedPointsRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BoundedPointsRequest.Merge(m, src)
}
...
func (*PointsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_453e3c55db197998, []int{3}
}
...
func init() {
	proto.RegisterFile("proto/map_service.proto", fileDescriptor_453e3c55db197998)
}

var fileDescriptor_453e3c55db197998 = []byte{
...
func (*UnimplementedMapServiceServer) AllPoints(ctx context.Context, req *PointRequest) (*PointsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AllPoints not implemented")
}
func (*UnimplementedMapServiceServer) BoundedPoints(ctx context.Context, req *BoundedPointsRequest) (*PointsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method BoundedPoints not implemented")
}
